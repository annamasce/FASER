...
void TPORecoEvent::ReconstructClusters(int view, double clusters_eps, double clusters_minPts, double clusters_threshold_2dhit) {
    ...
    std::cout << "Changing cluster reconstruction parameters for DBscan..." << std::endl;
    recoConfig.clusters_eps = clusters_eps;
    recoConfig.clusters_minPts = clusters_minPts;
    recoConfig.clusters_threshold_2dhit = clusters_threshold_2dhit;
    ReconstructClusters(view);
}
