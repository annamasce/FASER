...
namespace display
{
  ...
  void FaserCalDisplay::GetEventDisplay()
  {
    ...
    posy += 25;
    fClusterHits = new TGCheckButton(fGroupFrame2, "Clusters");
    fClusterHits->MoveResize(10, posy, 0, 18);
    fClusterHits->Connect("Clicked()", "display::FaserCalDisplay", this, "ShowClusterHits()");
